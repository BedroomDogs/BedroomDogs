...
The _BedroomDogs_ project was born from a Mafia and Driver mixture tech demo and is becoming a stable platform for various types of gameplay settings in a open  world third person shooter.
